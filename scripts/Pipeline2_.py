...
app = Celery('bio_pipeline', broker='pyamqp://guest:guest@localhost//')
...
def run_hhsearch(a3m_file):
    ...
    cmd = ['/home/dbuchan/Applications/hh-suite-3.3.0/build/bin/hhsearch',
           '-i', a3m_file, '-cpu', '1',
           '-d', '/home/dbuchan/Data/hhdb/pdb70/pdb70']
...
if __name__ == "__main__":
    ...
    for k, v in sequences.items():
        ...
        # Enqueue Celery tasks for parallel execution
        run_s4pred.delay(tmp_file, horiz_file)
        read_horiz.delay(tmp_file, horiz_file, a3m_file)
        run_hhsearch.delay(a3m_file)
        run_parser.delay(hhr_file)
